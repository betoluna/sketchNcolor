...
//    __debug && $('body').append('<div>drawMask '+ (+(new Date()) - tm) +'ms');
    ...
    if (typeof fb.callback == 'object') {
      ...
      $(fb.callback).each(function() {
        if ((typeof this.value == 'string') && this.value != fb.color) {
          ...
          // alert(this.value);		  
		  // to make it work with sketch.js and html coloring file
		  var el = document.getElementById('fromColorWheel');
		  el.setAttribute('data-color', this.value);
		  onmouseout=el.click(); 
        }
      });
    }
  ...
  // Set initial color.
  fb.setColor('#7c00fc');//#808080 gray
}
